...
public class FormAgregarReserva extends javax.swing.JDialog {
    ...
    public FormAgregarReserva(java.awt.Frame parent, boolean modal, Cliente cliente) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("NUEVA RESERVACIÓN");
...
//        txtfecha.setText(fecha);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAgregarReserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                FormAgregarReservacion dialog = new FormAgregarReservacion(new javax.swing.JFrame(), true);
...
//        java.awt.EventQueue.invokeLater(new Runnable() {
//            public void run() {
//                FormAgregarReserva dialog = new FormAgregarReserva(new javax.swing.JFrame(), true);
//                dialog.addWindowListener(new java.awt.event.WindowAdapter() {
//                    @Override
//                    public void windowClosing(java.awt.event.WindowEvent e) {
//                        System.exit(0);
